...
export interface IBlacklistableUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface IBlacklistableUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IBlacklistableUpgradeableInterface;
