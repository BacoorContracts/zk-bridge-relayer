...
import type {
  Create3,
  Create3Interface,
} from "../../../../oz-custom/contracts/libraries/Create3";

const _abi = [
  {
    inputs: [],
    name: "Create3__DeploymentFailed",
    type: "error",
  },
  {
    inputs: [],
    name: "Create3__InitializationFailed",
    type: "error",
  },
];

const _bytecode =
  "";
